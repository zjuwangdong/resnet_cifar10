...
def main(args):
    ...
    NUM_TRAIN = 45000
    NUM_VAL = 5000
    cifar10_train = dset.CIFAR10(args.data_dir, train=True, download=False,
    ...
    cifar10_val = dset.CIFAR10(args.data_dir, train=True, download=False,
    ...
    cifar10_test = dset.CIFAR10(args.data_dir, train=False, download=False,
                                transform=transform_normalize)
